"""
Django settings for sales_38539 project.
...
WSGI_APPLICATION = 'sales_38539.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sales_38539 API",
    "DESCRIPTION": "API documentation for sales_38539 App",
    "VERSION": "v1",
}
